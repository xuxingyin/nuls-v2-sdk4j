 ...
 * @Description:
 * 在调用注解 {@link io.icw.core.core.annotation.Configuration}了的类的setter方法时，判断setter方法修改的field是否有 {@link io.icw.core.core.annotation.Persist}注解，如果有这将保存最新的值到disk，供下次启动时注入
 */
